<?php /* Smarty version 2.6.26, created on 2012-05-08 12:55:41
    		...
    		<tr>
    			<td>Nombre: <input name="search" type = "text" id="search" value=""></td>
    		 	...
    		 	<option value="">Seleccione</option>
    				<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['grupos'],'selected' => $this->_tpl_vars['grupo_id']), $this);?>
